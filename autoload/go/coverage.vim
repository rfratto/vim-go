...
function! go#coverage#Buffer(bang, ...) abort
  ...
  if go#util#has_job()
    call s:coverage_job({
          \ 'cmd': ['go', 'test', '-tags', go#util#BuildTags(), '-coverprofile', l:tmpname] + a:000,
  ...
  let args = [a:bang, 0, '-tags', go#util#BuildTags(), "-coverprofile", l:tmpname]
  if a:0
...
function! go#coverage#Browser(bang, ...) abort
  ...
  if go#util#has_job()
    call s:coverage_job({
          \ 'cmd': ['go', 'test', '-tags', go#util#BuildTags(), '-coverprofile', l:tmpname],
